    ...
    <c:if test="${fn:length(activeTaskBo.taskAttributeValueBos) eq 0}">
      <c:forEach items="${activeTaskBo.taskMasterAttributeBos}" var="taskMasterAttributeBo">
        ...
        <c:if test="${taskMasterAttributeBo.orderByTaskType eq 4}">
          <div class="col-md-3 col-lg-3 p-none mr-lg">
            ...
            <input type="hidden" name="taskAttributeValueBos[3].activeTaskMasterAttrId"
                   value="${taskMasterAttributeBo.masterId}">
            <input type="hidden" name="taskAttributeValueBos[3].addToDashboard"
                   value="${taskMasterAttributeBo.addToDashboard}">
            <div class="form-group">
        ...
        <c:if test="${taskMasterAttributeBo.orderByTaskType eq 5}">
          <div class="col-md-3 col-lg-3 p-none mr-lg ml-lg">
            ...
            <input type="hidden" name="taskAttributeValueBos[4].activeTaskMasterAttrId"
                   value="${taskMasterAttributeBo.masterId}">
            <input type="hidden" name="taskAttributeValueBos[4].addToDashboard"
                   value="${taskMasterAttributeBo.addToDashboard}">
            <div class="form-group">
        ...
        <c:if test="${taskMasterAttributeBo.orderByTaskType eq 6}">
          <div class="col-md-3 col-lg-3 p-none mr-lg ml-lg">
            ...
            <input type="hidden" name="taskAttributeValueBos[5].activeTaskMasterAttrId"
                   value="${taskMasterAttributeBo.masterId}">
            <input type="hidden" name="taskAttributeValueBos[5].addToDashboard"
                   value="${taskMasterAttributeBo.addToDashboard}">
            <div class="form-group">
        ...
        <c:if test="${taskMasterAttributeBo.orderByTaskType eq 8}">
          ...
          <input type="hidden" name="taskAttributeValueBos[7].activeTaskMasterAttrId"
                 value="${taskMasterAttributeBo.masterId}">
          <input type="hidden" name="taskAttributeValueBos[7].addToDashboard"
                 value="${taskMasterAttributeBo.addToDashboard}">
                ...
                <div class="add_notify_option form-group">
                  <select
                    ...
                    <c:forEach items="${statisticImageList}" var="statisticImage">
                      <option
                          value="${statisticImage.statisticImageId}">${statisticImage.value}</option>
                    </c:forEach>
                  </select>
                  <div class="help-block with-errors red-txt"></div>
                </div>
        ...
        <c:if test="${taskMasterAttributeBo.orderByTaskType eq 9}">
          ...
          <input type="hidden" name="taskAttributeValueBos[8].activeTaskMasterAttrId"
                 value="${taskMasterAttributeBo.masterId}">
          <input type="hidden" name="taskAttributeValueBos[8].addToDashboard"
                 value="${taskMasterAttributeBo.addToDashboard}">
          <div class="bullets black-md-f pt-md">${taskMasterAttributeBo.displayName}</div>
          <div class="pl-xlg ml-xs bor-l-1-gray mt-lg">
            <div class="chartSection" style="display: none">
        ...
        <c:if test="${taskMasterAttributeBo.orderByTaskType eq 10}">
          ...
          <input type="hidden" name="taskAttributeValueBos[9].activeTaskMasterAttrId"
                 value="${taskMasterAttributeBo.masterId}">
          <input type="hidden" name="taskAttributeValueBos[9].addToDashboard"
                 value="${taskMasterAttributeBo.addToDashboard}">
          <div class="bullets black-md-f pt-md">${taskMasterAttributeBo.displayName}</div>
          <div class="pl-xlg ml-xs bor-l-1-gray mt-lg">
            <div class="chartSection" style="display: none">
    ...
    <c:if test="${fn:length(activeTaskBo.taskAttributeValueBos) gt 0}">
      ...
      <c:forEach items="${activeTaskBo.taskMasterAttributeBos}" var="taskMasterAttributeBo">
        <c:forEach items="${activeTaskBo.taskAttributeValueBos}" var="taskValueAttributeBo">
          ...
          <c:if
              test="${taskMasterAttributeBo.orderByTaskType eq 9 && taskMasterAttributeBo.masterId eq taskValueAttributeBo.activeTaskMasterAttrId}">
            <input type="hidden" name="taskAttributeValueBos[8].attributeValueId"
                   value="${taskValueAttributeBo.attributeValueId}">
            <input type="hidden" name="taskAttributeValueBos[8].activeTaskMasterAttrId"
                   value="${taskMasterAttributeBo.masterId}">
            <input type="hidden" name="taskAttributeValueBos[8].addToDashboard"
          ...
          <c:if
              test="${taskMasterAttributeBo.orderByTaskType eq 10 && taskMasterAttributeBo.masterId eq taskValueAttributeBo.activeTaskMasterAttrId}">
            <input type="hidden" name="taskAttributeValueBos[9].attributeValueId"
                   value="${taskValueAttributeBo.attributeValueId}">
            <input type="hidden" name="taskAttributeValueBos[9].activeTaskMasterAttrId"
                   value="${taskMasterAttributeBo.masterId}">
            <input type="hidden" name="taskAttributeValueBos[9].addToDashboard"
