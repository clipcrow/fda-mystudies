      ...
      <div id="rla" class="tab-pane fade mt-xlg">
                ...
                <div class="col-md-8 col-lg-8 pl-none">
                  ...
                  <div class="form-group col-smthumb-2">
                    <div class="sm-thumb-btn" onclick="openUploadWindow(this);">
                      ...
                      <c:if test="${empty questionsBo.questionReponseTypeBo.minImage}">
                        <div class="textLabelscaleMinImagePathId">Upload</div>
                      </c:if>
                      <c:if test="${not empty questionsBo.questionReponseTypeBo.minImage}">
                ...
                <div class="col-md-8 col-lg-8 pl-none">
                  ...
                  <div class="form-group col-smthumb-2">
                    <div class="sm-thumb-btn" onclick="openUploadWindow(this);">
                      ...
                      <c:if test="${empty questionsBo.questionReponseTypeBo.maxImage}">
                        <div class="textLabelscaleMaxImagePathId">Upload</div>
                      </c:if>
                      <c:if test="${not empty questionsBo.questionReponseTypeBo.maxImage}">
            ...
            <div class="col-md-6 pl-none">
              <div class="col-md-8 col-lg-8 pl-none">
                ...
                <div class="form-group col-smthumb-2">
                  ...
                  <input class="dis-none upload-image" data-imageId='0'
                         name="questionReponseTypeBo.minImageFile" id="continuesScaleMinImageFileId"
                         type="file" accept=".png, .jpg, .jpeg" onchange="readURL(this);">
                  <input type="hidden" name="questionReponseTypeBo.minImage"
            ...
            <div class="col-md-6">
              <div class="col-md-8 col-lg-8 pl-none">
                ...
                <div class="form-group col-smthumb-2">
                  ...
                  <input class="dis-none upload-image" data-imageId='1'
                         name="questionReponseTypeBo.maxImageFile" id="continuesScaleMaxImageFileId"
                         type="file" accept=".png, .jpg, .jpeg" onchange="readURL(this);">
                  <input type="hidden" name="questionReponseTypeBo.maxImage"
              ...
              <div class="col-md-12 col-lg-12 p-none">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" placeholder="1-50 characters"
                         id="textPlaceholderId" value="${fn:escapeXml(
              ...
              <div class="col-md-6 col-lg-4 p-none">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="questionReponseTypeBo.maxLength"
                         id="textmaxLengthId" value="${fn:escapeXml(
                ...
                <div class="col-md-3 pr-none pr-xs">
                  <div class="form-group">
                    <select name="questionReponseTypeBo.validationCharacters"
                            ...
                            <c:if
                                test="${empty questionsBo.questionReponseTypeBo.validationCondition}">disabled</c:if>>
                      <option value='' selected>Select</option>
                      <option
                  ...
                  <div class="col-md-9 pl-none pr-none">
                    <div class="form-group">
                      <textarea class="form-control" rows="3" cols="40"
                                ...
                                <c:if
                                    test="${empty questionsBo.questionReponseTypeBo.validationCondition}">disabled</c:if>>${questionsBo.questionReponseTypeBo.validationExceptText}</textarea>
                    </div>
                    <div class="help-block with-errors red-txt"></div>
                  </div>
            ...
            <div>
              <span class="radio radio-info radio-inline pr-sm">
                <input type="radio" class="HeightRequired" id="measurementSystemLocal"
                       value="Local"
                       name="questionReponseTypeBo.measurementSystem"  ${questionsBo.questionReponseTypeBo.measurementSystem eq 'Local'? 'checked':''} >
              ...
              <span class="radio radio-inline pr-sm">
                <input type="radio" class="HeightRequired" id="measurementSystemMetric"
                       value="Metric"
                       name="questionReponseTypeBo.measurementSystem" ${questionsBo.questionReponseTypeBo.measurementSystem eq 'Metric' ? 'checked':''} >
                <label for="measurementSystemMetric">Metric</label>
              </span>
              <span class="radio radio-inline">
                <input type="radio" class="HeightRequired" id="measurementSystemUS" value="US"
                       name="questionReponseTypeBo.measurementSystem" ${empty questionsBo.questionReponseTypeBo.measurementSystem || questionsBo.questionReponseTypeBo.measurementSystem eq 'US' ? 'checked':''} >
              ...
              <div class="col-md-12 col-lg-12 p-none">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" placeholder="1-20 characters"
                         id="heightPlaceholderId" value="${fn:escapeXml(
            ...
            <div class="col-md-2 pl-none">
              ...
              <div class="form-group">
                <input type="text" class="form-control TimeintervalRequired wid90"
                       id="timeIntervalStepId" value="${questionsBo.questionReponseTypeBo.step}"
                       onkeypress="return isNumber(event)" maxlength="2">
        ...
        <div id="Date" style="display: none;">
          ...
          <div id="customDateContainerId"
               <c:if
                   test="${questionsBo.questionReponseTypeBo.selectionStyle eq 'Until current date' || questionsBo.questionReponseTypeBo.selectionStyle eq 'After current date'}">style="display: none;"</c:if>>
            <div class="row">
              <div class="col-md-6 pl-none">
                <div class="col-md-8 col-lg-8 p-none">
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control" name="questionReponseTypeBo.minDate"
                           id="minDateId" value="${questionsBo.questionReponseTypeBo.minDate}">
                    <div class="help-block with-errors red-txt"></div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-8 col-lg-8 p-none">
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control" name="questionReponseTypeBo.maxDate"
                           id="maxDateId" value="${questionsBo.questionReponseTypeBo.maxDate}">
                    <div class="help-block with-errors red-txt"></div>
                  </div>
                </div>
              </div>
                  ...
                  <c:forEach items="${questionsBo.questionResponseSubTypeList}"
                    ...
                    <div class="value-picker row form-group mb-xs" id="${subtype.index}">
                      ...
                      <div class="col-md-2 pl-none mt__6">
                        <span
                            class="addBtnDis addbtn mr-sm align-span-center top6"
                ...
                <c:forEach items="${questionsBo.questionResponseSubTypeList}"
                  ...
                  <div class="text-choice mt-xlg" id="${subtype.index}">
                    ...
                    <div class="col-md-12 p-none display__flex__center">
                      ...
                      <div class="col-md-2 pl-none">
                        <span
                            class="addBtnDis addbtn align-span-center top6"
                    ...
                    <div class="form-group">
                      <select name="questionResponseSubTypeList[0].exclusive" id="exclusiveId0"
                              ...
                              <c:if
                                  test="${ empty questionsBo.questionReponseTypeBo.selectionStyle || questionsBo.questionReponseTypeBo.selectionStyle eq 'Single'}">disabled</c:if> >
                        <option
                            value="Yes" ${questionsBo.questionResponseSubTypeList[0].exclusive eq 'Yes' ? 'selected' :''}>
                          Yes
                        </option>
                        <option
                            value="No" ${questionsBo.questionResponseSubTypeList[0].exclusive eq 'No' ? 'selected' :''}>
                          No
                        </option>
                      </select>
                      <div class="help-block with-errors red-txt"></div>
                    ...
                    <div class="form-group">
                      <select name="questionResponseSubTypeList[1].exclusive" id="exclusiveId1"
                              ...
                              <c:if
                                  test="${ empty questionsBo.questionReponseTypeBo.selectionStyle || questionsBo.questionReponseTypeBo.selectionStyle eq 'Single'}">disabled</c:if> >
                        <option
                            value="Yes" ${questionsBo.questionResponseSubTypeList[1].exclusive eq 'Yes' ? 'selected' :''}>
                          Yes
                        </option>
                        <option
                            value="No" ${questionsBo.questionResponseSubTypeList[1].exclusive eq 'No' ? 'selected' :''}>
                          No
                        </option>
                      </select>
                      <div class="help-block with-errors red-txt"></div>
                  ...
                  <div class="col-md-2 pl-none col-smthumb-2">
                    <div class="form-group">
                      <div class="sm-thumb-btn" onclick="openUploadWindow(this);">
                        ...
                        <c:if test="${empty questionsBo.questionResponseSubTypeList[0].image}">
                          <div class="textLabelimagePathId0">Upload</div>
                        </c:if>
                        <c:if test="${not empty questionsBo.questionResponseSubTypeList[0].image}">
                  ...
                  <div class="col-md-2 pl-none col-smthumb-2">
                    <div class="form-group">
                      <div class="sm-thumb-btn" onclick="openUploadWindow(this);">
                        ...
                        <c:if test="${empty questionsBo.questionResponseSubTypeList[1].image}">
                          <div class="textLabelimagePathId1">Upload</div>
                        </c:if>
                        <c:if test="${not empty questionsBo.questionResponseSubTypeList[1].image}">
    ...
    $("#continuesScaleDefaultValueId").blur(function () {
      ...
      if (value != '') {
        if (parseInt(value) >= parseInt(minValue) && parseInt(value) <= parseInt(maxValue)) {
          ...
          $("#continuesScaleDefaultValueId").parent().find(".help-block").empty();
          $("#continuesScaleDefaultValueId").parent().find(".help-block").append(
            $("<ul><li> </li></ul>").attr("class","list-unstyled").text(
  ...
  function addTextChoice() {
    ...
    if (selectionStyle == 'Single') {
      newTextChoice += "<select name='questionResponseSubTypeList[" + choiceCount
          ...
          + " title='select' data-error='Please choose one option' class='selectpicker TextChoiceRequired textChoiceExclusive' disabled >";
    } else {
      newTextChoice += "<select name='questionResponseSubTypeList[" + choiceCount
          + "].exclusive' id='exclusiveId" + choiceCount + "' index=" + choiceCount
          + " title='select' data-error='Please choose one option' class='selectpicker TextChoiceRequired textChoiceExclusive' required >";
    }
