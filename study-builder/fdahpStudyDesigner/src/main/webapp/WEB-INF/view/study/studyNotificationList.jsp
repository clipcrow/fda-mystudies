...
<div class="col-sm-10 col-rc white-bg p-none">
  ...
  <div class="right-content-head">
    <div class="text-right">
      <div class="black-md-f text-uppercase dis-line pull-left line34">お知らせ通知</div>
              ...
              <td class="wid20 text-right">
                ...
                <c:if test="${not studyNotification.notificationSent}">
                  <span
                      ...
                      actionType="edit"
                      notificationId="${studyNotification.notificationId}"
                      data-toggle="tooltip" data-placement="top" title="編集"></span>
                </c:if>
                <span
                    ...
                    data-toggle="tooltip" data-placement="top" title="コピー"></span>
              </td>
            </tr>
          </c:forEach>
        </tbody>
...
<form:form action="/studybuilder/adminStudies/getStudyNotification.do?_S=${param._S}"
           id="getStudyNotificationEditPage"
...
<form:form action="/studybuilder/adminStudies/notificationMarkAsCompleted.do?_S=${param._S}"
