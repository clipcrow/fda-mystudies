  ...
  <div class="right-content-body pt-none pl-none pr-none">
    <ul class="nav nav-tabs review-tabs gray-bg">
      ...
      <li class="questionLevel">
        <a data-toggle="tab" href="#qla">質問定義</a>
      </li>
    ...
    <div class="tab-content pl-xlg pr-xlg">
      ...
      <div id="qla" class="tab-pane fade mt-xlg">
          ...
          <div id="chartContainer" style="display: none">
            ...
            <div>
              <div class="gray-xs-f mb-xs">チャートのやり直しを可能にしますか？
                <span
                    class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                    title="[はい]を選択すると、治験への登録日までチャートをロールバックできます。"></span>
              </div>
              <div>
                <span class="radio radio-info radio-inline p-45">
        ...
        <div id="statContainer" style="display: none">
          ...
          <div class="clearfix"></div>
          <div class="col-md-10 p-none">
            <div class="gray-xs-f mb-xs">モバイルアプリユーザーが利用できる時間範囲オプション</div>
            <div class="clearfix"></div>
          </div>
          <div class="clearfix"></div>
          <div>
        ...
        <div id="responseTypeDivId">
                ...
                <div class="col-md-6 col-lg-6 pl-none">
                  ...
                  <div class="form-group col-smthumb-2">
                    <div class="sm-thumb-btn" onclick="openUploadWindow(this);">
                      <div class="thumb-img">
                        <img
                            src="<spring:eval expression="@propertyConfigurer.getProperty('fda.imgDisplaydPath')" />${sessionObject.gcpBucketName}/questionnaire/${fn:escapeXml(questionnairesStepsBo.questionReponseTypeBo.minImage)}"
                ...
                <div class="col-md-6 col-lg-6 pl-none">
                  ...
                  <div class="form-group col-smthumb-2">
                    <div class="sm-thumb-btn" onclick="openUploadWindow(this);">
                      <div class="thumb-img">
                        <img
                            src="<spring:eval expression="@propertyConfigurer.getProperty('fda.imgDisplaydPath')" />${sessionObject.gcpBucketName}/questionnaire/${fn:escapeXml(questionnairesStepsBo.questionReponseTypeBo.maxImage)}"
                            onerror="this.src='/studybuilder/images/icons/sm-thumb.jpg';"
                            class="imageChoiceWidth" alt=""/>
                      </div>
                    ...
                    <input class="dis-none upload-image" data-imageId='1'
                           name="questionReponseTypeBo.maxImageFile" id="scaleMaxImageFileId"
                           type="file" accept=".png, .jpg, .jpeg" onchange="readURL(this);">
                ...
                <div class="col-md-6 col-lg-6 pl-none">
                  ...
                  <div class="form-group col-smthumb-2">
                    ...
                    <input class="dis-none upload-image" data-imageId='0'
                           ...
                           id="continuesScaleMinImageFileId" type="file" accept=".png, .jpg, .jpeg"
                ...
                <div class="col-md-6 col-lg-6 pl-none">
                  ...
                  <div class="form-group col-smthumb-2">
                    ...
                    <input class="dis-none upload-image" data-imageId='1'
                           ...
                           id="continuesScaleMaxImageFileId" type="file" accept=".png, .jpg, .jpeg"
                           onchange="readURL(this);">
                    <input type="hidden" name="questionReponseTypeBo.maxImage"
                ...
                <div class="col-md-12 col-lg-12 p-none">
                  ...
                  <div class="col-md-3 pr-none pr-xs">
                    <div class="form-group">
                      <select name="questionReponseTypeBo.validationCharacters"
                              ...
                              <c:if
                                  test="${empty questionnairesStepsBo.questionReponseTypeBo.validationCondition }">disabled</c:if>>
                        <option value='' selected>Select</option>
                        <option
                  ...
                  <div class="col-md-6 pl-none">
                    ...
                    <div class="form-group col-md-9 pl-none pr-none">
                      ...
                      <div class=""><textarea class="form-control" rows="3" cols="40"
                                              name="questionReponseTypeBo.validationExceptText"
                                              id="validationExceptTextId"
                                              <c:if
                                                  test="${empty questionnairesStepsBo.questionReponseTypeBo.validationCondition }">disabled</c:if> >${questionnairesStepsBo.questionReponseTypeBo.validationExceptText}</textarea>
                      </div>
                      <div class="help-block with-errors red-txt"></div>
                    </div>
          ...
          <div id="Date" style="display: none;">
            ...
            <div id="customDateContainerId"
                 <c:if
                     test="${questionnairesStepsBo.questionReponseTypeBo.selectionStyle eq 'Until current date' || questionnairesStepsBo.questionReponseTypeBo.selectionStyle eq 'After current date'}">style="display: none;"</c:if>>
              <div class="row">
                <div class="col-md-6 pl-none">
                  <div class="col-md-8 col-lg-8 p-none">
          ...
          <div id="Boolean" style="display: none;">
            ...
            <div class="row mt-xs" id="0">
              <input type="hidden" class="form-control" id="responseSubTypeValueId0"
              ...
              <div class="col-md-3 pl-none">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" id="dispalyText0"
                         name="questionResponseSubTypeList[0].text" value="Yes" readonly="readonly">
                  <div class="help-block with-errors red-txt"></div>
                </div>
              </div>
              <div class="col-md-3 pl-none">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" id="displayValue0" value="True"
                         name="questionResponseSubTypeList[0].value" readonly="readonly">
                  <div class="help-block with-errors red-txt"></div>
                </div>
              </div>
              <c:if test="${questionnaireBo.branching}">
                <div class="col-md-3 pl-none">
                  <div class="gray-xs-f mb-xs">分岐先ステップ
                    <span
                        class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                        title="アンケートに分岐が適用されている場合は、解答によって次のステップを定義できます。"></span>
                  </div>
                  <div class="form-group">
            ...
            <div class="row" id="1">
              <div class="col-md-3 pl-none">
                <input type="hidden" class="form-control" id="responseSubTypeValueId1"
                ...
                <div class="form-group">
                  <input type="text" class="form-control" id="dispalyText1"
                         name="questionResponseSubTypeList[1].text" value="No" readonly="readonly">
                  <div class="help-block with-errors red-txt"></div>
                </div>
              </div>
              <div class="col-md-3 pl-none">
                <div class="form-group">
                  <input type="text" class="form-control" id="displayValue1" value="False"
                         name="questionResponseSubTypeList[1].value" readonly="readonly">
                  <div class="help-block with-errors red-txt"></div>
                </div>
              </div>
              <c:if test="${questionnaireBo.branching}">
                      ...
                      <div class="col-md-2 pl-none mt__8">
                        <c:choose>
                          <c:when
                            ...
                            <span
                                class='tool-tip' data-toggle='tooltip' data-placement='top'
                                title='Only a max of 8 rows are allowed'>
                              <span
                        ...
                        <div class="col-md-2 pl-none">
                          ...
                          <div class="form-group">
                            <select
                                ...
                                <c:if
                                    test="${not empty questionResponseSubType.exclusive &&  questionResponseSubType.exclusive eq 'No'}">disabled</c:if>>
                              <option value="">select</option>
                              <c:forEach items="${destinationStepList}"
                                         var="destinationStep">
                                <option
                    ...
                    <div class="col-md-2 pl-none">
                      ...
                      <div class="form-group mb-none">
                        <select name="questionResponseSubTypeList[0].exclusive"
                                ...
                                onchange="setExclusiveData(this);">
                          <option
                              value="Yes" ${questionnairesStepsBo.questionResponseSubTypeList[0].exclusive eq 'Yes' ? 'selected' :''}>
                            Yes
                          </option>
                          <option
                              value="No" ${questionnairesStepsBo.questionResponseSubTypeList[0].exclusive eq 'No' ? 'selected' :''}>
                            No
                          </option>
                        </select>
                        <div class="help-block with-errors red-txt"></div>
                      ...
                      <div class="col-md-2 pl-none">
                        ...
                        <div class="form-group">
                          <select name="questionResponseSubTypeList[1].destinationStepId"
                                  ...
                                  class="selectpicker destionationYes"
                                  <c:if
                                      test="${not empty questionnairesStepsBo.questionResponseSubTypeList[1].exclusive && questionnairesStepsBo.questionResponseSubTypeList[1].exclusive eq 'No'}">disabled</c:if>>
                            <option value="" selected>select</option>
                            <c:forEach items="${destinationStepList}" var="destinationStep">
                              <option
                                  value="${destinationStep.stepId}" ${questionResponseSubType.destinationStepId eq destinationStep.stepId ? 'selected' :''} >
            ...
            <div>
              ...
              <div class="textchoiceOtherCls" style="display: none;">
                ...
                <div class="mt-xlg">
                  ...
                  <div class="col-md-2 pl-none">
                    <div class="gray-xs-f mb-xs">排他的項目にしますか？
                      <span
                          class="requiredStar">*
                      </span>
                    </div>
                    <div class="form-group">
                      <select name="questionReponseTypeBo.otherExclusive" id="" title="select"
                        ...
                        <option
                            value="Yes" ${questionnairesStepsBo.questionReponseTypeBo.otherExclusive eq 'Yes' ? 'selected' :''}>
                          Yes
                        </option>
                        <option
                            value="No" ${questionnairesStepsBo.questionReponseTypeBo.otherExclusive eq 'No' ? 'selected' :''}>
                          No
                        </option>
                      </select>
                      <div class="help-block with-errors red-txt"></div>
                    ...
                    <div class="col-md-2 pl-none">
                      ...
                      <div class="form-group">
                        <select name="questionReponseTypeBo.otherDestinationStepId"
                                ...
                                class="selectpicker destionationYes"
                                <c:if
                                    test="${not empty questionnairesStepsBo.questionReponseTypeBo.otherExclusive && questionnairesStepsBo.questionReponseTypeBo.otherExclusive eq 'No'}">disabled</c:if>>
                          <option value="" selected>Select</option>
                          <c:forEach items="${destinationStepList}" var="destinationStep">
                            <option
                ...
                <div class="mt-lg">
                  <div>
                    <span
                        class="gray-xs-f mb-xs pr-md">「その他」のテキストボックスを設けますか？
                    </span>
                ...
                <div class="OtherOptionCls" style="display:none;">
                  ...
                  <div class="col-md-6 p-none mt-md">
                    <div class="gray-xs-f mb-xs pr-md">プレースホルダー</div>
                    <div class="form-group">
                      <input type="text" class="form-control"
                  ...
                  <div class="mt-lg">
                    <div>
                      <span class="gray-xs-f mb-xs pr-md">このテキストボックスは必須入力にしますか？
                      </span>
                      <span class="radio radio-info radio-inline pr-md">
                        <input type="radio" class="" id="pYes" value="Yes"
                               name="questionReponseTypeBo.otherParticipantFill" ${questionnairesStepsBo.questionReponseTypeBo.otherParticipantFill=='Yes' ?'checked':''}>
                        <label for="pYes">はい</label>
                      </span>
                      <span class="radio radio-inline">
                        <input type="radio" class="" id="pNo" value="No"
                               name="questionReponseTypeBo.otherParticipantFill" ${empty questionnairesStepsBo.questionReponseTypeBo.otherParticipantFill  || questionnairesStepsBo.questionReponseTypeBo.otherParticipantFill=='No' ?'checked':''}>
                        <label for="pNo">いいえ</label>
                      </span>
                    </div>
                  </div>
                </div>
                      ...
                      <div class="col-md-2 pl-none col-smthumb-2">
                        <div class="form-group">
                          <div class="sm-thumb-btn" onclick="openUploadWindow(this);">
                            ...
                            <div class="textLabelselectImagePathId${subtype.index}">Change
                            </div>
                          </div>
                          <input
                    ...
                    <div class="col-md-2 pl-none col-smthumb-2">
                      <div class="form-group">
                        <div class="sm-thumb-btn" onclick="openUploadWindow(this);">
                          <div class="thumb-img">
                            <img
                                src="<spring:eval expression="@propertyConfigurer.getProperty('fda.imgDisplaydPath')" />${sessionObject.gcpBucketName}/questionnaire/${fn:escapeXml(questionnairesStepsBo.questionResponseSubTypeList[0].image)}"
                                onerror="this.src='/studybuilder/images/icons/sm-thumb.jpg';"
                                class="imageChoiceWidth"/>
                          </div>
                          <c:if
                    ...
                    <div class="col-md-2 pl-none col-smthumb-2">
                      <div class="form-group">
                        <div class="sm-thumb-btn" onclick="openUploadWindow(this);">
                          <div class="thumb-img">
                            <img
                                src="<spring:eval expression="@propertyConfigurer.getProperty('fda.imgDisplaydPath')" />${sessionObject.gcpBucketName}/questionnaire/${fn:escapeXml(questionnairesStepsBo.questionResponseSubTypeList[0].selectedImage)}"
                                onerror="this.src='/studybuilder/images/icons/sm-thumb.jpg';"
                                class="imageChoiceWidth"/>
                          </div>
                          <c:if
                    ...
                    <div class="col-md-2 pl-none col-smthumb-2">
                      <div class="form-group">
                        <div class="sm-thumb-btn" onclick="openUploadWindow(this);">
                          <div class="thumb-img">
                            <img
                                src="<spring:eval expression="@propertyConfigurer.getProperty('fda.imgDisplaydPath')" />${sessionObject.gcpBucketName}/questionnaire/${fn:escapeXml(questionnairesStepsBo.questionResponseSubTypeList[1].image)}"
                                onerror="this.src='/studybuilder/images/icons/sm-thumb.jpg';"
                                class="imageChoiceWidth"/>
                          </div>
                          <c:if
                    ...
                    <div class="col-md-2 pl-none col-smthumb-2">
                      <div class="form-group">
                        <div class="sm-thumb-btn" onclick="openUploadWindow(this);">
                          <div class="thumb-img">
                            <img
                                src="<spring:eval expression="@propertyConfigurer.getProperty('fda.imgDisplaydPath')" />${sessionObject.gcpBucketName}/questionnaire/${fn:escapeXml(questionnairesStepsBo.questionResponseSubTypeList[1].selectedImage)}"
                                onerror="this.src='/studybuilder/images/icons/sm-thumb.jpg';"
                                class="imageChoiceWidth"/>
                          </div>
                          <c:if
                        ...
                        <div class="numeric__section mt-md" id="rootId1">
                          <div class="numeric__define gray__t">
                            ...
                            <input type="hidden"
                                   ...
                                   id="inputTypeId0" value="MF">
                            <input type="hidden"
                                   name="questionConditionBranchBoList[0].sequenceNo"
                                   id="sequenceNoId0" value="1">
                            <input type="hidden"
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header trial_header">
            <button type="button" id="closeformulaId" class="close" data-dismiss="modal">&times;
            </button>
          </div>
                ...
                if (message == "SUCCESS") {
                  ...
                  if (formulaResponseJsonObject.outPutData == 'true'
                    ...
                    $('#outputId').empty().append(
                            $("<font> </font>").attr("class","gtxtf").empty().append($("<B> </B>").text(formulaResponseJsonObject.outPutData)));
                  } else {
                    $('#outputId').empty().append(
                            $("<font> </font>").attr("class","rtxtf").empty().append($("<B> </B>").text(formulaResponseJsonObject.outPutData)));
                  }
                } else {
